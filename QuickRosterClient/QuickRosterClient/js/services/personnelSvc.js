...
app.factory('personnelSvc', ['$resource', '$q', function ($resource, $q) {
    // var resource = $resource('/api/Personnel/:section/:id', { section: '@section', id: '@id' });
    return {
        getModel: function () {
            //call get
            return getFakePersonnelList();
        },
        ...
        //getModel: function (dataSection, id) {
        //    var deferred = $q.defer();
        //    resource.get({ section: dataSection, id: id },
        //		function (event) {
        ...
        //},
        //queryModel: function (dataSection, id) {
        //    var deferred = $q.defer();
        //    resource.query({ section: dataSection, id: id },
        //		function (event) {
        //		    deferred.resolve(event);
        //		},
        //		function (response) {
        ...
        //    return deferred.promise;
        //},
        //save: function (scope, dataSection, data, form) {
        //    var deferred = $q.defer();
        //    resource.save({ section: dataSection }, data,
        //        function (response) {
        ...
        //    return deferred.promise;
        //},
        //saveAndClose: function (dataSection, data) {
        //    var deferred = $q.defer();
        //    resource.save({ section: dataSection }, data,
        //		function (response) {
        //		    deferred.resolve(response);
